...
# --------------------------------- dayag code ---------------------------------
    ...
    path('adminliquidation/Scholarship_Program', views.scholarship_program, name='ScholarshipProgram'),
    path('adminliquidation/Scholarship_Billing_Report', views.scholarship_billing_report, name='ScholarshipBillingReport'),
    path('adminliquidation/FUR/Admin_Cost_Liquidation', views.Admin_cost_liquidation, name='AdminCostLiquidation'),
